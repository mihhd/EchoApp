...
export default class Contact extends Component {
  ...
  postMsg = (name, mobile, email, msg, nameClear, mobileClear, emailClear, msgClear) => {
    ...
    render() {
      return (
        <Container>
        <Header androidStatusBarColor="#85a190" style={{ backgroundColor: '#85a190' }}>
          ...
          <Content>
            ...
            <View>
                <CardItem>
                    <Item>
                      <Icon active name="ios-checkmark-circle" style={{fontSize: 30, color: '#85a190', marginLeft:5, marginRight:10}} />
